...
const Features = () => {
  return (
    <div id="features">
      ...
      <img src="assets/images/icons/rain.svg" alt="Rain icon" />
      ...
      <img src="assets/images/icons/wifi.svg" alt="Wifi icon" />
      ...
      <img src="assets/images/icons/fire.svg" alt="Fire icon" />
      <h3>Survival Kit</h3>
